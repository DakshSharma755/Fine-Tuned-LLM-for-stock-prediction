# src/model_training/sentimentft.py
...
def main():
    ...
    #BASE_MODEL_ID = "penscola/sentence_sentiments_analysis_bert"
    
    PROCESSED_DATASET_PATH = PROJECT_ROOT / "data" / "processed" / "sentiment_training_data.jsonl"
    PROCESSED_MODEL_PATH = PROJECT_ROOT / "models" / "processed" / f"{BASE_MODEL_ID.replace('/', '_')}-sentiment-generalist-v1"
